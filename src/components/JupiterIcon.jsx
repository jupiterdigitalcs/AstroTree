export function JupiterIcon({ size = 32, className }) {
  ...
  if (size <= 22) {
    return (
      ...
      >
        <defs>
          <radialGradient id="jup-sm-depth" cx="40%" cy="35%" r="70%">
          ...
          {/* wider, softer glint so it reads as highlight not a spot */}
          <radialGradient id="jup-sm-glint" cx="33%" cy="26%" r="48%">
            <stop offset="0%"   stopColor="#e6c76e" stopOpacity="0.28" />
            <stop offset="100%" stopColor="#e6c76e" stopOpacity="0"    />
          </radialGradient>
          <radialGradient id="jup-sm-storm" cx="50%" cy="50%" r="50%">
            <stop offset="0%"   stopColor="#c9943e" stopOpacity="0.6" />
            <stop offset="100%" stopColor="#c9943e" stopOpacity="0"   />
          </radialGradient>
          <clipPath id="jup-sm-clip">
            <circle cx="12" cy="12" r="11" />
          </clipPath>
          <filter id="jup-sm-blur" x="-80%" y="-80%" width="260%" height="260%">
            <feGaussianBlur stdDeviation="0.7" />
          </filter>
        </defs>
        <circle cx="12" cy="12" r="11" fill="#0d0a22" />
        <g clipPath="url(#jup-sm-clip)">
          ...
          <circle cx="12" cy="12" r="11" fill="url(#jup-sm-depth)" />
          <circle cx="12" cy="12" r="11" fill="url(#jup-sm-glint)"  />
          {/* small storm — bottom-right quadrant */}
          <ellipse cx="17" cy="16.5" rx="3.2" ry="1.8"
            fill="url(#jup-sm-storm)" filter="url(#jup-sm-blur)" />
  ...
  //
  // Bands near the storm (bands 5-7) curve AROUND the storm oval rather than
  // passing through it — simulating how Jupiter's atmospheric bands flow around
  // the Great Red Spot.  Storm sits at cx=42 cy=38 (lower-right quadrant).
  return (
    <svg
    ...
    >
      <defs>
        ...
        <clipPath id="jup-lg-clip">
          <circle cx="30" cy="30" r="27.5" />
        </clipPath>
        <filter id="jup-storm-blur" x="-40%" y="-40%" width="180%" height="180%">
      ...
      <g clipPath="url(#jup-lg-clip)">
        ...
        {/*
          ...
          Bands curve AWAY from the storm centre — above it they rise,
          below it they dip — the storm sits in the "eye" of that parting.
        */}

        {/* band 5 — bright gold, bottom edge curves UP above the storm */}
        ...
        {/* band 6 — purple, top and bottom both deform around the storm */}
        {/* top edge matches band 5's modified bottom exactly */}
        ...
        {/* band 7 — gold, top edge curves DOWN below the storm */}
        ...
        {/*
          ── Great Storm ─────────────────────────────────────────────────
          Warm amber-ochre, sits in the parted band region, not too loud.
          Outer halo blurred, inner oval solid but low opacity.
        */}
        <ellipse cx="42" cy="37" rx="9" ry="5"
          fill="url(#jup-storm-grad)"
          filter="url(#jup-storm-blur)"
        />
        ...
        <circle cx="30" cy="30" r="27.5" fill="url(#jup-lg-depth)" />
        <circle cx="30" cy="30" r="27.5" fill="url(#jup-lg-glint)"  />
      </g>

      {/* Outer gold edge glow */}
      <circle cx="30" cy="30" r="27.5" fill="url(#jup-lg-glow)" />
