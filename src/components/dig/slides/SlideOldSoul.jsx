...
export default function SlideOldSoul({ data, active }) {
  ...
  return (
    <div className="dig-slide-content dig-sparkles">
      <p className="dig-label dig-fly-in" style={{ '--i': 0 }}>The Anchor</p>
      ...
      <p className="dig-body dig-fade-in" style={{ '--i': 3 }}>
        With {animCount} Earth placements, {d.name.split(' ')[0]} tends to be the steadying
        presence here. Practical, patient, and built to last.
      </p>
      <p className="dig-body dig-fade-in" style={{ '--i': 4, fontSize: '0.75rem', opacity: 0.5, marginTop: '0.6rem' }}>
        Often the one others turn to when things get real
      </p>
    </div>
  )
}
